...
class ImapClientRunnableIT {

    private static final Pattern CAPTURED_CERTIFICATES = Pattern.compile("\\* [1-9]+: imaps://outlook\\.office365\\.com:993");

    @Test
    void shouldPrintCertificates() {
        ConsoleCaptor consoleCaptor = new ConsoleCaptor();
        Request request = CertificateRipper.print("imaps://outlook.office365.com:993").build();
