...
class MySQLClientRunnableIT {

    private static final Pattern CAPTURED_CERTIFICATES = Pattern.compile("\\* [1-9]+: mysql://localhost:3306");
    ...
    void shouldPrintCertificates() throws IOException {
        ...
        Request request = CertificateRipper.print("mysql://localhost:3306").build();
